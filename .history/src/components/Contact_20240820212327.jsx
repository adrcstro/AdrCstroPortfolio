...
function Contact() {
  ...
  <div className="flex items-center  p-4 rounded-lg min-w-[70px]">
    ...
    <h4 className="flex items-center text-lg text-slate-400 font-bold"><a href="https://www.facebook.com/profile.php?id=100009241129573" target="_blank" rel="noreferrer">Andre Thomas Castro <FaArrowUpRightFromSquare className='w-4 h-4 ml-2 text-slate-400 '/></a>
</h4>
