...
function Projects({ isDarkMode }) {
  ...
  <div className={`card bg-blue-200 w-full shadow-xl flex flex-col ${isDarkMode ? 'bg-slate-800 ' : 'text-primary-800'}`}>
  ...
  <div className={`card bg-violet-300  w-full shadow-xl flex flex-col ${isDarkMode ? 'bg-slate-800 ' : 'text-primary-800'}`}>
    <figure className="px-4 pt-10">
      <img
        src={thumb4}
        alt="Shoes"
  ...
  <div className={`card bg-stone-300 w-full shadow-xl flex flex-col ${isDarkMode ? 'bg-slate-800 ' : 'text-primary-800'}`}></div>
    <figure className="px-4 pt-10">
      <img
        src={thumb6}
        alt="Shoes"
