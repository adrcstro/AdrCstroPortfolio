...
function Contact() {
  ...
  <div className="flex items-center  p-4 rounded-lg min-w-[70px]">
    ...
    <h4 className="text-lg text-slate-400 font-bold"><a href='https://www.instagram.com/_adrcstro/'>_adrcstro</a></h4>
  ...
  <div className="flex items-center  p-4 rounded-lg min-w-[70px]">
    ...
    <h4 className="text-lg text-slate-400 font-bold"><a href='https://x.com/LiquidoAndre'>@LiquidoAndre</a></h4>
  ...
  <div className="flex items-center  p-4 rounded-lg min-w-[70px]">
    ...
    <h4 className="text-lg text-slate-400 font-bold"><a href='https://github.com/adrcstro'>adrcstro</a></h4>
