...
function Toolsandtechnologies() {
  ...
  <div className='inline-block bg-slate-200 p-2 rounded-lg mb-4 w-32 h-40'>
    <img className='mx-auto rounded-lg h-24 w-24' src={html} alt='/' />
    <p className='text-sm text-center font-semibold'>HTML</p>
  </div>

  <div className='inline-block bg-slate-200 p-2 rounded-lg mb-4 w-32 h-40'>
    <img className='mx-auto rounded-lg h-24 w-24' src={Css} alt='/' />
    <p className='text-sm text-center font-semibold'>CSS</p>
  </div>

  <div className='inline-block bg-slate-200 p-2 rounded-lg mb-4 w-32 h-40'>
    <img className='mx-auto rounded-lg h-24 w-24' src={js} alt='/' />
    <p className='text-sm text-center font-semibold'>Javascript</p>
  </div>

  <div className='inline-block bg-slate-200 p-2 rounded-lg mb-4 w-32 h-40'>
    <img className='mx-auto rounded-lg h-24 w-24' src={react} alt='/' />
