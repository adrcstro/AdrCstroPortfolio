        ...
        <div className="flex flex-col lg:flex-row items-center">
          ...
          <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <motion.div
              ...
              whileInView={"show"}
              viewport={{ once: false, amount: 0.7 }}
              className={`relative p-4 border-4 border-gray-400 rounded-lg shadow-lg ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}
            >
              <FcManager className='absolute top-2 left-2 w-6 h-6' />
            ...
            <motion.div
              ...
              className={`relative p-4 border-4 border-gray-400 rounded-lg shadow-lg ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}
            >
              <FcIdea className='absolute top-2 left-2 w-6 h-6' />
              <h3 className={`flex items-center text-xl font-bold mb-4 ${isDarkMode ? 'text-white' : 'text-black'}`}>
                Interests & Hobbies
              </h3>
              <p className={`text-sm ${isDarkMode ? 'text-slate-400' : 'text-slate-500'}`}>
            ...
            <motion.div
              ...
              className={`relative p-4 border-4 border-gray-400 rounded-lg shadow-lg ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}
            >
              <FcComboChart className='absolute top-2 left-2 w-6 h-6' />
              <h3 className={`flex items-center text-xl font-bold mb-4 ${isDarkMode ? 'text-white' : 'text-black'}`}>
                Goals & Aspirations
              </h3>
              <p className={`text-sm ${isDarkMode ? 'text-slate-400' : 'text-slate-500'}`}>
            ...
            <motion.div
              ...
              className={`relative p-4 border-4 border-gray-400 rounded-lg shadow-lg ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}
            >
              <FcServices className='absolute top-2 left-2 w-6 h-6' />
              <h3 className={`flex items-center text-xl font-bold mb-4 ${isDarkMode ? 'text-white' : 'text-black'}`}>
                Skills & Abilities
              </h3>
              <p className={`text-sm ${isDarkMode ? 'text-slate-400' : 'text-slate-500'}`}>
