...
function About() {
  return (
    ...
    <img className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-[400px] rounded-full mx-auto" src={profile} alt="can_help_banner" />
</div>
        ...
        <div className="flex-1 flex flex-col sm:flex-row flex-wrap -mb-4 -mx-2">
            ...
            <div className="w-full sm:w-1/2 mb-4 px-2">
                <div className="h-full py-4 px-6 border border-[#570df8] border-t-0 border-l-0 rounded-br-xl">
                    <h3 className="flex text-2xl font-bold text-md mb-6">Interest & Hobbies <FcIdea className='mr-4 w-6 h-6'/></h3>
                    <p className="text-sm">
