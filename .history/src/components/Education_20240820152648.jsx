...
function Education() {
  ...
  <div className="flex items-center bg-slate-200 p-2 rounded-lg mb-4 min-w-[70px]">
    <img className="rounded-lg w-16 h-16 mr-4" src={Educ1} alt="React Js" />
    <p className="text-lg font-semibold">Eulogio "Amang" Rodriguez Institute of Science and Technology</p>
