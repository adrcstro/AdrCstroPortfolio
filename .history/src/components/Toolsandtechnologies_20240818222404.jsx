...
function Toolsandtechnologies() {
  return (
    ...
    <div className='flex flex-wrap justify-center gap-8 max-w-screen-xl w-full mx-auto'>
  <div className='flex flex-col items-center bg-slate-200 p-2 rounded-lg mb-4 min-w-[70px] flex-shrink-0 w-1/4 sm:w-1/4 md:w-1/8'>
