        ...
        <div className="flex-1 flex flex-col sm:flex-row flex-wrap -mb-4 -mx-2">
            <div className="w-full sm:w-1/2 mb-4 px-2">
                <div className="h-full py-4 px-6 border border-[#570df8] border-t-0 border-l-0 rounded-br-xl">
                    <h3 className="flex text-2xl font-bold text-md mb-6">Personal Identification<FcManager className='ml-2 w-6 h-6' /></h3>
            ...
            <div className="w-full sm:w-1/2 mb-4 px-2">
                <div className="h-full py-4 px-6 border border-[#570df8] border-t-0 border-l-0 rounded-br-xl">
                    <h3 className="flex text-2xl font-bold text-md mb-6">Goals and Aspirations <FcComboChart className='ml-2 w-6 h-6'/></h3>
                    <p className="text-sm">
