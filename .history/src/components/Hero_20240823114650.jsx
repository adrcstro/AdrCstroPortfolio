       ...
       className="hero-content text-center">
        <div className="max-w-3xl">
          ...
          <div className='justify-between'>  
            <button className="btn btn-primary text-white mr-4 font-bold shadow-lg rounded-full px-8">
              <IoDocumentTextOutline className='w-5 h-5'/>Resume
            </button>

            <Link to="Contact" spy={true} smooth={true} offset={-70}  duration={500}>
            <button className={`btn btn-transparent shadow-lg font-bold border rounded-full px-8 ${isDarkMode ? 'border-white' : 'border-gray-900'}`}>
