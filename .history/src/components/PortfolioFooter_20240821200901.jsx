...
<div className={`${isDarkMode ? 'bg-gray-900' : 'bg-white'} w-full`}>
  ...
  <div className={`py-6 text-center md:text-left ${isDarkMode ? 'bg-slate-800' : 'text-primary-800'}`}>
    <div className="flex flex-col gap-4 items-center md:flex-row md:gap-16 md:justify-center">
      <a href="#link1" className="text-slate-400 font-bold hover:underline">Home</a>
      <a href="#link2" className="text-slate-400 font-bold hover:underline">About</a>
      <a href="#link3" className="text-slate-400 font-bold hover:underline">Tools & Technologies</a>
      <a href="#link4" className="text-slate-400 font-bold hover:underline">Experience</a>
      <a href="#link5" className="text-slate-400 font-bold hover:underline">Project</a>
      <a href="#link6" className="text-slate-400 font-bold hover:underline">Contact</a>
    </div>
  </div>

  {/* <!-- Copyright section --> */}

  <div className={`bg-slate-800 p-2 text-center text-slate-400 ${isDarkMode ? 'bg-slate-800' : 'text-primary-800'}`}>
