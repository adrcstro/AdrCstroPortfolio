...
function Projects() {
  ...
  <div className="card bg-blue-300 w-full shadow-xl">
    ...
    <div className="py-4 px-4 items-center text-first">
      <h2 className="font-bold text-md px-4">ResiQuest:(Automated Document Request Management System Web-Application)</h2>
      <p className='px-4 text-sm text-slate-700'>Brgy-409 Document Request Management System(DRMS)</p>
    </div>
