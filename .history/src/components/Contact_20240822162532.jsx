...
function Contact({isDarkMode}) {
  ...
  <div className="flex items-center  p-4 rounded-lg min-w-[70px]">
    ...
    <h4 className="flex items-center text-lg text-slate-400 font-bold">live:.cid.dc9638a93c52d16a <a href='' target="_blank" rel="noreferrer"><FaArrowUpRightFromSquare className='w-4 h-4 ml-2 text-slate-400 transition-transform transform hover:scale-105 '/></a></h4> 
  ...
  <div className="flex items-center  p-4 rounded-lg min-w-[70px]">
    ...
    <h4 className="flex items-center text-lg text-slate-400 font-bold">+63 9284864322 <a href='' target="_blank" rel="noreferrer"><FaArrowUpRightFromSquare className='w-4 h-4 ml-2 text-slate-400 transition-transform transform hover:scale-105 '/></a></h4> 
  ...
  <div className="flex items-center  p-4 rounded-lg min-w-[70px]">
    ...
    <div className='flex-grow'> 
    <p className='text-md mb-[-6px] font-semibold text-slate-400'>Contact Number (Philippines +63)</p>
    <h4 className="flex items-center text-lg text-slate-400 font-bold">+63 9284864322 <a href='' target="_blank" rel="noreferrer"><FaArrowUpRightFromSquare className='w-4 h-4 ml-2 text-slate-400 transition-transform transform hover:scale-105 '/></a></h4> 
</div>
  </div>
