    ...
    <div name="Experience" className={`w-full ${isDarkMode ? 'bg-gray-900' : 'bg-white'} py-8`}>
      <div className={`max-w-screen-xl mx-auto py-8 px-8 lg:py-16 lg:px-6 ${isDarkMode ? 'text-white' : 'text-black'}`}>
        <div className="text-center mb-10">
          ...
          className={`text-md font-bold mt-2 ${isDarkMode ? 'text-slate-400' : 'text-slate-500'}`}>Professional Experience</motion.p>
        </div>
        ...
        <div className="space-y-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-300 before:to-transparent">
          ...
          <motion.div
           ...
           whileInView={"show"}
           viewport={{once: false, amount:0.7}}
           className={`relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active ${isDarkMode ? 'bg-transparent' : 'bg-transparent'}`}>
          ...
          <motion.div
           ...
           className={`relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active ${isDarkMode ? 'bg-transparent' : 'bg-transparent'}`}>
            ...
            <div className={`w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-4 rounded border ${isDarkMode ? 'border-gray-600 bg-gray-800' : 'border-slate-200'} shadow`}>
              <div className="flex items-center justify-between space-x-2 mb-1">
                <div className={`font-bold ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>LittleWiz <span className='text-slate-500 text-sm'>LANGSYS:Language Learning System (20 Foreign Language to Learn)</span></div>
