...
function Education() {
  ...
  <div className="flex-grow items-center bg-slate-200 p-2 rounded-lg mb-4 min-w-[70px]">
    <img className="rounded-lg w-16 h-16 mr-4" src={Educ1} alt="React Js" />
    <p className="text-sm font-bold">Eulogio "Amang" Rodriguez Institute of Science and Technology</p>
    <p>2021-Present</p>
  </div>
</div>
