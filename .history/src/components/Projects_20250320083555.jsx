...
function Projects({ isDarkMode }) {
  ...
  variants={fadeIn("left",0.2)}
   ...
   className={`card bg-[#F7DCB9] w-full shadow-xl flex flex-col ${isDarkMode ? 'bg-slate-800 ' : 'text-primary-800'}`}>
    ...
    <div className='flex justify-end p-4 gap-2 mt-auto'>
      <div className='bg-slate-600 rounded-lg p-2 transition-transform transform hover:scale-105'><a href='https://withcenter-developer-exam-u2ix.vercel.app/' target="_blank" rel='noreferrer'><FaGithub className='w-4 h-4 text-white'/></a></div>
