...
<div className='mt-3'>
  <h3 className='font-semibold text-md bg-slate-200 inline-flex items-center px-4 py-1 rounded-full'>
    ...
    I'm Andre Castro
        ...
        <p className="py-6">
        Transforming complex technical challenges into innovative, high-quality digital solutions with a strong emphasis on performance, security, scalability, and user-centered design, ensuring seamless and engaging experiences across all platforms.
        </p>
