  ...
  return (
    ...
    <div className="flex flex-col md:flex-row">
        ...
        <div className="mr-0 md:mr-8 mb-6 md:mb-0 flex-shrink-0">
            <img className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-[300px] rounded-full mx-auto" src={profile} alt="Profile" />
        </div>
        ...
        <div className="flex-1 flex flex-col sm:flex-row flex-wrap">
            <div className="w-full sm:w-1/2 px-2 mb-4">
                <div className="h-full py-4 px-6 border border-[#570df8] border-t-0 border-l-0 rounded-br-xl">
                    <h3 className="flex text-xl font-bold mb-4">Personal Identification<FcManager className='ml-2 w-5 h-6' /></h3>
                    <p className="text-sm text-slate-500">
                        Hi! I'm Andre Thomas Castro and I'm a Full stack web developer. I'm 21 years old and currently living in Antipolo, Philippines.
                    </p>
                </div>
            </div>
            <div className="w-full sm:w-1/2 px-2 mb-4">
                <div className="h-full py-4 px-6 border border-[#570df8] border-t-0 border-l-0 rounded-br-xl">
                    <h3 className="flex text-xl font-bold mb-4">Interest & Hobbies <FcIdea className='ml-2 w-5 h-6'/></h3>
                    <p className="text-sm text-slate-500">
            ...
            <div className="w-full sm:w-1/2 px-2 mb-4">
                <div className="h-full py-4 px-6 border border-[#570df8] border-t-0 border-l-0 rounded-br-xl">
                    <h3 className="flex text-xl font-bold mb-4">Goals and Aspirations <FcComboChart className='ml-2 w-5 h-6'/></h3>
                    <p className="text-sm text-slate-500">
            ...
            <div className="w-full sm:w-1/2 px-2 mb-4">
                <div className="h-full py-4 px-6 border border-[#570df8] border-t-0 border-l-0 rounded-br-xl">
                    <h3 className="flex text-xl font-bold mb-4">Skills and Abilities <FcServices className='ml-2 w-5 h-6' /></h3>
                    <p className="text-sm text-slate-500">
