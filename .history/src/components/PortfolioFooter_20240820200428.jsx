...
<footer
      ...
      <div className="flex justify-center items-center gap-4 mx-6 py-10 text-center md:text-center">
        <div className="grid-1 grid gap-2 md:grid-cols-2 lg:grid-cols-6">
          {/* <!-- TW Elements section --> */}
          <div >
            <h6
