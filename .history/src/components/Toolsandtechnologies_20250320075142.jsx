...
function Toolsandtechnologies({ isDarkMode }) {
  ...
  <div className={`flex flex-col items-center ${isDarkMode ? 'bg-gray-700' : 'bg-slate-200'} p-2 rounded-lg mb-4 min-w-[70px]`}>
    ...
    <p className={`text-sm text-center font-semibold font-montserrat ${isDarkMode ? 'text-white' : 'text-slate-600'}`}>React Js</p>
  </div>

  <div className={`flex flex-col items-center ${isDarkMode ? 'bg-gray-700' : 'bg-slate-200'} p-2 rounded-lg mb-4 min-w-[70px]`}>
    <img className='mx-auto rounded-lg' src={java} alt='Java' />
    <p className={`text-sm text-center font-semibold font-montserrat ${isDarkMode ? 'text-white' : 'text-slate-600'}`}>Java</p>
  </div>

  <div className={`flex flex-col items-center ${isDarkMode ? 'bg-gray-700' : 'bg-slate-200'} p-2 rounded-lg mb-4 min-w-[70px]`}>
    <img className='mx-auto rounded-lg' src={mysql} alt='MySQL' />
    <p className={`text-sm text-center font-semibold font-montserrat ${isDarkMode ? 'text-white' : 'text-slate-600'}`}>MySQL</p>
  </div>

  <div className={`flex flex-col items-center ${isDarkMode ? 'bg-gray-700' : 'bg-slate-200'} p-2 rounded-lg mb-4 min-w-[70px]`}>
    <img className='mx-auto rounded-lg' src={Bootstrap} alt='Bootstrap' />
    <p className={`text-sm text-center font-semibold font-montserrat ${isDarkMode ? 'text-white' : 'text-slate-600'}`}>Bootstrap</p>
  </div>

  <div className={`flex flex-col items-center ${isDarkMode ? 'bg-gray-700' : 'bg-slate-200'} p-2 rounded-lg mb-4 min-w-[70px]`}>
    <img className='mx-auto rounded-lg' src={Git} alt='Git' />
    <p className={`text-sm text-center font-semibold font-montserrat ${isDarkMode ? 'text-white' : 'text-slate-600'}`}>Git</p>
  </div>
