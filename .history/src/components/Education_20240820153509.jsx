...
function Education() {
  ...
  <div className="flex items-center border border-slate-200 shadow-lg p-4 rounded-lg mb-4 min-w-[70px]">
  ...
  <div className="flex items-center border border-slate-200 shadow-lg p-4 rounded-lg mb-4 min-w-[70px]">
    <img className="rounded-lg w-16 h-16 mr-4" src={Educ1} alt="React Js" />
    <div className='flex-grow'> <p className="text-sm font-bold">Bachelor of Science in Computer Sciennce</p>
    <p className='text-sm text-slate-400'>2021-Present</p>
