...
<div className='mt-3'>
  ...
  <div className="flex flex-col items-center space-y-1 shrink-0 w-full sm:w-1/2 md:w-1/4">
    <p className="font-semibold bg-slate-200 rounded-lg py-2 px-2">+2.5</p>
    <p className="text-sm text-center">Years of<br />Experience</p>
  </div>
  <div className="flex flex-col items-center space-y-1 shrink-0 w-full sm:w-1/2 md:w-1/4">
    <p className="font-semibold bg-slate-200 rounded-lg py-2 px-2">+10</p>
    <p className="text-sm text-center">Accomplished<br />Project</p>
  </div>
  <div className="flex flex-col items-center space-y-1 shrink-0 w-full sm:w-1/2 md:w-1/4">
    <p className="font-semibold bg-slate-200 rounded-lg py-2 px-2">50k</p>
    <p className="text-sm text-center">Lines of Code<br />Written</p>
  </div>
  <div className="flex flex-col items-center space-y-1 shrink-0 w-full sm:w-1/2 md:w-1/4">
    <p className="font-semibold bg-slate-200 rounded-lg py-2 px-2">2k</p>
    <p className="text-sm text-center">Cups of Coffee<br />Consumed</p>
  </div>
</div>
