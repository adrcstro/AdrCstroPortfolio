...
function Contact() {
  ...
  <div className="flex items-center  p-4 rounded-lg min-w-[70px]">
    ...
    <h4 className="flex items-center text-lg text-slate-400 font-bold">live:.cid.dc9638a93c52d16a <FaArrowUpRightFromSquare className='w-4 h-4 ml-2 text-slate-400 '/></h4> 
  ...
  <div className="flex items-center  p-4 rounded-lg min-w-[70px]">
    ...
    <h4 className="flex items-center text-lg text-slate-400 font-bold">+63 9284864322 <FaArrowUpRightFromSquare className='w-4 h-4 ml-2 text-slate-400 '/></h4> 
