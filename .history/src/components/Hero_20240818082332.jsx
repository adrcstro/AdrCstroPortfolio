...
<div className='mt-3'>
  ...
  <div className="flex items-center space-x-2 shrink-0 mt-2">
    ...
    <p className="text-sm font-semi-bold text-start">Years of<br/>Experience</p>
  </div>
  <div className="flex items-center space-x-2 shrink-0 mt-2">
    <p className="font-semibold bg-slate-200 rounded-lg py-2 px-2">+10</p>
    <p className="text-sm font-semi-bold text-start">Accomplished<br/>Project</p>
  </div>
  <div className="flex items-center space-x-2 shrink-0 mt-2">
    <p className="font-semibold bg-slate-200 rounded-lg py-2 px-2">+50k</p>
    <p className="text-sm font-semi-bold  text-start">Lines of Code<br/>Written</p>
  </div>
  <div className="flex items-center space-x-2 shrink-0 mt-2">
    <p className="font-semibold bg-slate-200 rounded-lg py-2 px-2">+2k</p>
    <p className="text-sm font-semi-bold text-start">Cups of Coffee<br/>Consumed</p>
  </div>
</div>
