...
import thumb7 from '../assets/ProjectsAsset/cofeeappthumbnail.png'
import thumb8 from '../assets/ProjectsAsset/OTPThumbnail.png'
import thumb9 from '../assets/ProjectsAsset/Calculatorthumbnail.png'
...
function Projects() {
  ...
  <div className="card bg-stone-300 w-full shadow-xl flex flex-col">
    ...
    <div className="py-2 px-4 flex-grow items-center text-first">
      <h2 className="font-bold text-md px-4">Cloud Management Landing Page (Cloned)</h2>
  ...
  <div className="card bg-[#F7DCB9] w-full shadow-xl flex flex-col">
    ...
    <div className="py-2 px-4 flex-grow items-center text-first">
      <h2 className="font-bold text-md px-4">BrewBuddy: Mobile base Coffee Shop Ordering System</h2>
      <p className='px-4 text-sm text-slate-600'>Solution for managing coffee shop operations In Mobile App Environment</p>
    </div>
    <div className='flex justify-end p-4 gap-2 mt-auto'>
      <div className='bg-slate-600 rounded-lg p-2'><FaGithub className='w-4 h-4 text-white'/></div>
      <div className='bg-slate-600 rounded-lg p-2'><FaArrowUpRightFromSquare className='w-4 h-4 text-white'/></div>
  ...
  <div className="card bg-rose-200 w-full shadow-xl flex flex-col">
    <figure className="px-4 pt-10">
      <img 
        src={thumb8}
        alt="Shoes"
    ...
    <div className="py-2 px-4 flex-grow items-center text-first">
      <h2 className="font-bold text-md px-4">One Time Password Verification for Login System</h2>
      <p className='px-4 text-sm text-slate-600'>Web base OTP Verification System for Login System</p>
    </div>
    <div className='flex justify-end p-4 gap-2 mt-auto'>
      <div className='bg-slate-600 rounded-lg p-2'><FaGithub className='w-4 h-4 text-white'/></div>
      <div className='bg-slate-600 rounded-lg p-2'><FaArrowUpRightFromSquare className='w-4 h-4 text-white'/></div>
  ...
  <div className="card bg-neutral-300 w-full shadow-xl flex flex-col">
    <figure className="px-4 pt-10">
      <img 
        src={thumb9}
        alt="Shoes"
    ...
    <div className="py-2 px-4 flex-grow items-center text-first">
      <h2 className="font-bold text-md px-4">Web Base Calculator</h2>
      <p className='px-4 text-sm text-slate-600'>Web base Calculator using HTML,CSS & JS</p>
    </div>
    <div className='flex justify-end p-4 gap-2 mt-auto'>
      <div className='bg-slate-600 rounded-lg p-2'><FaGithub className='w-4 h-4 text-white'/></div>
      <div className='bg-slate-600 rounded-lg p-2'><FaArrowUpRightFromSquare className='w-4 h-4 text-white'/></div>
