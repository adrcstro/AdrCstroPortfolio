           ...
           viewport={{once: false, amount:0.7}}
             className="w-full sm:w-1/2 mb-4 px-2">
              <div className={`h-full py-4 px-6 border border-[#570df8] border-t-0 border-l-0 rounded-br-xl ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
                ...
                <p className={`font-montserrat text-sm text-justify ${isDarkMode ? 'text-slate-400' : 'text-slate-500'}`}>
                  Hi! I'm Andre Tomas Castro and I'm a Full stack web developer base in philippines. I'm 21 years old and currently living here in Antipolo, Philippines .
                </p>
              </div> 
            </motion.div>
