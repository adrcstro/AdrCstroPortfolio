  ...
  <div className="modal-box w-11/12 max-w-6xl h-auto md:h-[600px]">
    ...
    <div className="flex flex-col h-full p-4 overflow-hidden">
      ...
      <div className="w-full h-full overflow-y-auto">
        {/* Carousel Section */}
        <div className="carousel w-full h-full border-2 border-slate-400">
          {[
            { id: "slide1", img: resi6, next: "#slide2", prev: "#slide4" },
            { id: "slide2", img: resi5, next: "#slide3", prev: "#slide1" },
            { id: "slide3", img: resi4, next: "#slide4", prev: "#slide2" },
            { id: "slide4", img: resi3, next: "#slide1", prev: "#slide3" },
