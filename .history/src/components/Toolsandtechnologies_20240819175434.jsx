...
import android from '../assets/cakephp.png'
import visualstudio from '../assets/mysqlworkbench.png'
...
function Toolsandtechnologies() {
  return (
    ...
    <div className="text-center mb-10">
        <h2 className="text-4xl tracking-tight font-bold text-primary-800">Ski<span className='text-[#570df8] text-3xl'>lls.</span></h2>
  ...
  <div className='flex flex-col items-center bg-slate-200 p-2 rounded-lg mb-4 min-w-[70px]'>
    <img className='mx-auto rounded-lg' src={Git} alt='Bootstrap' />
    <p className='text-sm text-center font-semibold'>Git</p>
  </div>

  <div className='flex flex-col items-center bg-slate-200 p-2 rounded-lg mb-4 min-w-[70px]'>
    <img className='mx-auto rounded-lg' src={github} alt='Bootstrap' />
    <p className='text-sm text-center font-semibold'>Github</p>
  </div>

  <div className='flex flex-col items-center bg-slate-200 p-2 rounded-lg mb-4 min-w-[70px]'>
    <img className='mx-auto rounded-lg w-[48px]' src={cpanel}  alt='Bootstrap' />
    <p className='text-sm text-center font-semibold'>Cpanel </p>
  </div>

  <div className='flex flex-col items-center bg-slate-200 p-2 rounded-lg mb-4 min-w-[70px]'>
    <img className='mx-auto rounded-lg w-[48px]' src={material }  alt='Bootstrap' />
    <p className='text-sm text-center font-semibold'>Material UI</p>
  </div>


  <div className='flex flex-col items-center bg-slate-200 p-2 rounded-lg mb-4 min-w-[70px]'>
    <img className='mx-auto rounded-lg w-[48px]' src={npm}  alt='Bootstrap' />
    <p className='text-sm text-center font-semibold'>NPM</p>
  </div>


  <div className='flex flex-col items-center bg-slate-200 p-2 rounded-lg mb-4 min-w-[70px]'>
    <img className='mx-auto rounded-lg w-[48px]' src={tailwindcss}  alt='Bootstrap' />
    <p className='text-sm text-center font-semibold'>Tailwind Css</p>
  </div>


  <div className='flex flex-col items-center bg-slate-200 p-2 rounded-lg mb-4 min-w-[70px]'>
    <img className='mx-auto rounded-lg w-[48px]' src={vscode}  alt='Bootstrap' />
    <p className='text-sm text-center font-semibold'>VS Code</p>
  </div>


  <div className='flex flex-col items-center bg-slate-200 p-2 rounded-lg mb-4 min-w-[70px]'>
    <img className='mx-auto rounded-lg w-[48px]' src={figma}  alt='Bootstrap' />
    <p className='text-sm text-center font-semibold'>Figma</p>
  </div>


  <div className='flex flex-col items-center bg-slate-200 p-2 rounded-lg mb-4 min-w-[70px]'>
    <img className='mx-auto rounded-lg w-[48px]' src={Chrome}  alt='Bootstrap' />
    <p className='text-sm text-center font-semibold'>Chrome</p>
  </div>

  <div className='flex flex-col items-center bg-slate-200 p-2 rounded-lg mb-4 min-w-[70px]'>
    <img className='mx-auto rounded-lg mt-2 w-[48px]' src={php}  alt='Bootstrap' />
    <p className='text-sm text-center font-semibold mt-2'>PHP</p>
  </div>

  <div className='flex flex-col items-center bg-slate-200 p-2 rounded-lg mb-4 min-w-[70px]'>
    <img className='mx-auto rounded-lg w-[48px]' src={phpserver}  alt='Bootstrap' />
    <p className='text-sm text-center font-semibold'>PHP Server</p>
  </div>

  <div className='flex flex-col items-center bg-slate-200 p-2 rounded-lg mb-4 min-w-[70px]'>
    <img className='mx-auto rounded-lg w-[48px]' src={phyton}  alt='Bootstrap' />
    <p className='text-sm text-center font-semibold'>Python</p>
  </div>

  <div className='flex flex-col items-center bg-slate-200 p-2 rounded-lg mb-4 min-w-[70px]'>
    <img className='mx-auto rounded-lg w-[48px]' src={reactnative}  alt='Bootstrap' />
    <p className='text-sm text-center font-semibold'>React Native</p>
  </div>


  <div className='flex flex-col items-center bg-slate-200 p-2 rounded-lg mb-4 min-w-[70px]'>
    <img className='mx-auto rounded-lg w-[48px]' src={intellij}  alt='Bootstrap' />
    <p className='text-sm text-center font-semibold'>Intellij IDEA</p>
  </div>

  <div className='flex flex-col items-center bg-slate-200 p-2 rounded-lg mb-4 min-w-[70px]'>
    <img className='mx-auto rounded-lg w-[48px]' src={pycharm}  alt='Bootstrap' />
    <p className='text-sm text-center font-semibold'>PyCharm</p>
  </div>

  <div className='flex flex-col items-center bg-slate-200 p-2 rounded-lg mb-4 min-w-[70px]'>
    <img className='mx-auto rounded-lg w-[48px]' src={node}  alt='Bootstrap' />
    <p className='text-sm text-center font-semibold'>Node Js</p>
  </div>

  <div className='flex flex-col items-center bg-slate-200 p-2 rounded-lg mb-4 min-w-[70px]'>
    <img className='mx-auto rounded-lg w-[48px]' src={canva}  alt='Bootstrap' />
    <p className='text-sm text-center font-semibold'>Canva</p>
  </div>

  <div className='flex flex-col items-center bg-slate-200 p-2 rounded-lg mb-4 min-w-[70px]'>
    <img className='mx-auto rounded-lg w-[48px]' src={xampp}  alt='Bootstrap' />
    <p className='text-sm text-center font-semibold'>Xampp</p>
  </div>
  <div className='flex flex-col items-center bg-slate-200 p-2 rounded-lg mb-4 min-w-[70px]'>
    <img className='mx-auto rounded-lg w-[48px]' src={gradle}  alt='Bootstrap' />
    <p className='text-sm text-center font-semibold'>Gradle</p>
  </div>
  <div className='flex flex-col items-center bg-slate-200 p-2 rounded-lg mb-4 min-w-[70px]'>
    <img className='mx-auto rounded-lg w-[48px]' src={cakephp}  alt='Bootstrap' />
    <p className='text-sm text-center font-semibold'>CakePHP</p>
  </div>
  <div className='flex flex-col items-center bg-slate-200 p-2 rounded-lg mb-4 min-w-[70px]'>
    <img className='mx-auto rounded-lg w-[48px]' src={workbench}  alt='Bootstrap' />
    <p className='text-sm text-center font-semibold'>WorkBench</p>
  </div>

  <div className='flex flex-col items-center bg-slate-200 p-2 rounded-lg mb-4 min-w-[70px]'>
    <img className='mx-auto rounded-lg w-[48px]' src={android}  alt='Bootstrap' />
    <p className='text-sm text-center font-semibold'>Android Studio</p>
  </div>
  <div className='flex flex-col items-center bg-slate-200 p-2 rounded-lg mb-4 min-w-[70px]'>
    <img className='mx-auto rounded-lg w-[48px]' src={visualstudio}  alt='Bootstrap' />
