           ...
           viewport={{once: false, amount:0.7}}
            className="w-full sm:w-1/2 mb-4 px-2">
              <div className={`h-full py-4 px-6 border border-[#570df8] border-t-0 border-l-0 rounded-br-xl ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
                ...
                <p className={`text-sm ${isDarkMode ? 'text-slate-400' : 'text-slate-500'}`}>
                  My Goals and Inspiration as a Developer is learn heavy backend technologies I aim to continuously learn and stay updated with the latest trends, contributing to the open-source community
                </p>
              </div>
            </motion.div>
