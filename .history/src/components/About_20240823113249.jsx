           ...
           viewport={{once: false, amount:0.7}}
             className="w-full sm:w-1/2 mb-4 px-2">
              <div className={`h-full py-4 px-6 border border-[#570df8] border-t-0 border-l-0 rounded-br-xl ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
                ...
                enhance user experiences. In my free time, I enjoy experimenting with new tools, contributing to open-source projects
                </p>
              </div>
            </motion.div>
            ...
            className="w-full sm:w-1/2 mb-4 px-2">
              <div className={`h-full py-4 px-6 border border-[#570df8] border-t-0 border-l-0 rounded-br-xl ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
                ...
                <p className={`text-sm text-justify ${isDarkMode ? 'text-slate-400' : 'text-slate-500'}`}>
                  ...
                  I strive to optimize performance and collaborate effectively, ensuring innovative and seamless web experiences. 
                </p>
              </div>
            </motion.div>
