        ...
        <div className="space-y-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-300 before:to-transparent">
          ...
          <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
            ...
            <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white p-4 rounded border border-slate-200 shadow">
              ...
              <div className="text-slate-500">
                <div className="font-bold text-slate-900">Role: <span className='text-slate-500 text-sm'>Front End Developer</span></div>
                <h3 className='font-bold text-black'>Description:</h3>
                <p className='text-sm text-slate-500'>Description of the project and role.</p>
                <h3 className='font-bold text-black'>Technology Used:</h3>
                <div className='flex p-2 gap-2'>
                  <SiPhp className='w-10 h-10'/>
                  <FaHtml5 className='w-10 h-10'/>
