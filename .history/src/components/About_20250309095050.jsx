        ...
        <div className="flex flex-col lg:flex-row items-center">
          ...
          <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <motion.div
              ...
              whileInView={"show"}
              viewport={{ once: false, amount: 0.7 }}
              className={`p-4 border-2 border-[#570df8] rounded-lg ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}
            >
            ...
            >
              ...
              <p className={`text-sm ${isDarkMode ? 'text-slate-400' : 'text-slate-500'}`}>
                Proficient in HTML, CSS, JavaScript, and React, with experience in creating responsive designs using Tailwind CSS. I am proficient in front-end technologies like HTML, CSS, and JavaScript, with experience in creating responsive designs using frameworks like Tailwind CSS and libraries such as React.
              </p>
            </motion.div>
          </div>
        </div>
