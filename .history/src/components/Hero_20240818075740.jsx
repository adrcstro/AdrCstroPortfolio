...
<div className='mt-3'>
  <h3 className='font-semibold text-md bg-slate-200 inline-flex items-center px-4 py-1 rounded-full'>
    ...
    I'm Andre Castro
        ...
        <div className="flex bg-slate-50 mt-4 mb-4  flex-col md:flex-row md:items-center justify-between py-6 px-4 md:px-8 lg:px-16 space-y-4 md:space-y-0">
    <p className="text-sm">
        <span className="font-semibold bg-slate-200 mr-2 rounded-lg py-2 px-1">+2.5</span>Years of Experience
    </p>
    <p className="text-sm">
        <span className="font-semibold bg-slate-200 mr-2 rounded-lg py-2 px-1">8+</span>Accomplished Projects
    </p>
    <p className="text-sm">
        <span className="font-semibold bg-slate-200 mr-2 rounded-lg py-2 px-1">2K</span>Cup of Coffee Consumed
    </p>
</div>
