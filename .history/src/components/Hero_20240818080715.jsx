...
<div className='mt-3'>
  <h3 className='font-semibold text-md bg-slate-200 inline-flex items-center px-4 py-1 rounded-full'>
    ...
    I'm Andre Castro
        ...
        <div className="flex flex-col md:flex-row md:flex-wrap md:items-center justify-center md:justify-between py-6 px-4 md:px-8 lg:px-16 space-y-4 md:space-y-0">
  <div className="flex flex-col items-center md:items-start space-x-0 md:space-x-2">
    <p className="font-semibold bg-slate-200 rounded-lg py-2 px-2 mb-1">+2.5</p>
    <p className="text-sm text-center md:text-left">Years of<br/>Experience</p>
  </div>
  <div className="flex flex-col items-center md:items-start space-x-0 md:space-x-2">
    <p className="font-semibold bg-slate-200 rounded-lg py-2 px-2 mb-1">+2.5</p>
    <p className="text-sm text-center md:text-left">Years of<br/>Experience</p>
