...
function Projects({ isDarkMode }) {
  ...
  <h2 className={`font-bold text-md px-4 md:text-center  ${isDarkMode ? 'text-white' : 'text-slate-800'}`}>ResiQuest:(Automated Document Request Management System Web-Application)</h2>
