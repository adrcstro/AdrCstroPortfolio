...
function Navbar({ isDarkMode, toggleTheme }) {
  return (
    <div className={`navbar bg-base-100 max-w-screen-xl mx-auto py-8 px-8 lg:py-16 lg:px-6 shadow-lg sticky top-0 z-50 ${isDarkMode ? 'bg-gray-800 text-white' : 'bg-base-100 text-black'}`}>
      <div className="navbar-start">
        <div className="dropdown">
          ...
          >
            <li className={`text-sm font-semibold transition-transform transform hover:scale-105  font-montserrat ${isDarkMode ? 'hover:bg-gray-700' : 'hover:bg-gray-300'}`}>
              <Link to="Home" spy={true} smooth={true} offset={-160}  duration={500}>Home</Link>
            </li>
            <li className={`transition-transform transform hover:scale-105 text-sm font-semibold  font-montserrat ${isDarkMode ? 'hover:bg-gray-700' : 'hover:bg-gray-300'}`}>
