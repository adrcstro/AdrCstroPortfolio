...
function About() {
  return (
    ...
    <div className="text-center mb-10">
        <h2 className="text-4xl tracking-tight font-bold text-primary-800">About<span className='text-[#570df8] text-3xl'>Me.</span></h2>
    </div>

    <div className="flex flex-col lg:flex-row">
        {/* can help image */}
        <div className="mr-0 md:mr-8 mb-6 md:mb-0">
    <img className="w-full max-w-xs sm:max-w-sm md:max-w-sm lg:max-w-[250px] rounded-full mx-auto" src={profile} alt="can_help_banner" />
</div>
