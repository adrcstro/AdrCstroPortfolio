...
function Hero({ isDarkMode }) {
  return (
    <div name="Home" className={`hero min-h-screen ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-white text-black'}`}>
      ...
      >
        <div className="max-w-3xl font-montserrat"> {/* Applied font globally to container */}
          <div className='mt-3'>
            <h3 className={`font-semibold text-md inline-flex items-center px-4 py-1 rounded-full ${isDarkMode ? 'bg-gray-700' : 'bg-slate-200'} font-montserrat`}>
              Hi
              <span className='ml-2'>
          ...
          <h1 style={{ fontFamily: "Montserrat, sans-serif" }}>Full Stack Web Developer</h1>
          <h1 className="text-5xl lg:text-6xl md:text-3xl font-bold mt-4 font-montserrat">
            Full Stack Web Developer based in Philippines
          </h1>
          ...
          <div className="flex flex-wrap justify-between py-6 px-4 md:px-8 lg:px-16">
            <motion.div
              ...
              whileInView={"show"}
              viewport={{ once: false, amount: 0.7 }}
              className="flex items-center space-x-2 shrink-0 mt-2 font-montserrat"
            >
            ...
            >
              ...
              <p className="text-sm font-semibold text-start">Accomplished<br />Projects</p>
            </motion.div>
          ...
          <div className='justify-between font-montserrat'>
            <button
