  ...
  <div className="modal-box w-11/12 max-w-6xl h-auto md:h-[600px]">
    ...
    <div className="flex items-center flex-col h-full p-4">
      ...
      <div className="w-full p-4 md:mt-4">
        ...
        <p className="mt-2 text-slate-600 text-justify"><span>Description:</span> ResiQuest: An Automated Document Request Management System is a software solution designed to streamline and 
