...
function Experience({ isDarkMode }) { // Accept isDarkMode as a prop
  return (
    <div className={`${isDarkMode ? 'bg-gray-900' : 'bg-white'} w-full`}>
     <div className="max-w-screen-xl mx-auto py-8 px-8 lg:py-16 lg:px-6">
      ...
      <div className="space-y-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-300 before:to-transparent">
        ...
        {/* Order Placed */}
        <div className={`relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active ${isDarkMode ? 'bg-gray-900' : 'bg-white'}`}>
          ...
          <div className={`w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-4 rounded border ${isDarkMode ? 'border-gray-600 bg-gray-900' : 'border-slate-200'} shadow`}>
        ...
        {/* Order Shipped */}
        <div className={`relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active ${isDarkMode ? 'bg-gray-700' : 'bg-white'}`}>
