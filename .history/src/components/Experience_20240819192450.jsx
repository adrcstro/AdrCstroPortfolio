        ...
        <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
          ...
          <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white p-4 rounded border border-slate-200 shadow">
            <div className="flex items-center justify-between space-x-2 mb-1">
              <div className=" text-slate-900">ResiQuest <span className='text-slate-400 text-sm'>(Automated Document Request Management System)</span></div>
              <time className="font-caveat font-medium text-indigo-500">2023/2024</time>
            </div>
            <div className="text-slate-500">
            <h3 className='font-bold '>Description</h3>
             <p>Pretium lectus quam id leo. Urna et pharetra aliquam vestibulum morbi blandit cursus risus.</p>
