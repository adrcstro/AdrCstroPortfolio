...
function Contact({isDarkMode}) {
  ...
  <div className="flex items-center  p-4 rounded-lg min-w-[70px]">
    ...
    <h4 className="flex items-center text-lg text-slate-400 font-bold"><a href='https://www.instagram.com/_adrcstro/ ' target="_blank" rel="noreferrer">_adrcstro <FaArrowUpRightFromSquare className='w-4 h-4 ml-2 text-slate-400 transition-transform transform hover:scale-105 '/></a> </h4>
