...
function Projects() {
  ...
  <div className="card bg-blue-200 w-full shadow-xl">
    ...
    <div className="py-2 px-4 items-center text-first">
...
<div className='bg-slate-600 rounded-lg p-2'><FaGithub className='w-3 h-3 text-white'/></div>
<div className='bg-slate-600 rounded-lg p-2'><FaArrowUpRightFromSquare className='w-3 h-3 text-white'/></div>
      </div>
  </div>
