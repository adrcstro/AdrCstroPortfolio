...
<div className='bg-slate-600 rounded-lg p-2'><FaGithub className='w-5 h-5 text-white'/></div>
<div className='bg-slate-600 rounded-lg p-2'><FaArrowUpRightFromSquare className='w-5 h-5 text-white'/></div>
