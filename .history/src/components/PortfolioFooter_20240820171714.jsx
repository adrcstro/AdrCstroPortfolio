...
function PortfolioFooter() {
  return (
<footer className="footer footer-center bg-base-200 text-base-content rounded p-6 md:p-10">
  <nav className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-4 md:gap-8">
  ...
  <aside className="mt-4">
    <p className="text-xs sm:text-sm">Copyright © {new Date().getFullYear()} - All right reserved by Andre Thomas Castro</p>
  </aside>
</footer>
<footer className="footer footer-center bg-base-200 text-base-content rounded p-6 md:p-10">
  <nav className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-4 md:gap-8">
