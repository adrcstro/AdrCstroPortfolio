           ...
           viewport={{once: false, amount:0.7}}
             className="w-full sm:w-1/2 mb-4 px-2">
              <div className={`h-full py-4 px-6 border border-[#570df8] border-t-0 border-l-0 rounded-br-xl ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
                <h3 className={`flex text-2xl font-bold text-md mb-6 font-montserrat ${isDarkMode ? 'text-white' : 'text-black'}`}>
           ...
           viewport={{once: false, amount:0.7}}
             className="w-full sm:w-1/2 mb-4 px-2">
              <div className={`h-full py-4 px-6 border border-[#570df8] border-t-0 border-l-0 rounded-br-xl ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
                ...
                <p className={`text-sm text-justify font-montserrat ${isDarkMode ? 'text-slate-400' : 'text-slate-500'}`}>
                I'm passionate about web development and enjoy exploring new technologies and design trends. I love coding, especially when it comes to creating clean,  responsive user interfaces and solving complex problems. 
