...
function Projects() {
  ...
  <div className="card bg-blue-400 w-full shadow-xl">
    ...
    <div className="py-4 px-4 items-center text-center">
      <h2 className="font-bold text-lg px-4">ResiQuest:(Automated Document Request Management System Web-Application)</h2>
    </div>
