    ...
    <div className="flex flex-col h-full p-4 overflow-hidden">
      ...
      <div className={`w-full h-full overflow-y-auto ${isDarkMode ? 'text-slate-300' : 'text-slate-800'}`}>
        ...
        <div className="w-full p-4 mt-4">
          ...
          <p className={`text-justify ${isDarkMode ? 'text-slate-300' : 'text-slate-800'}`}>
            <span className={`font-bold ${isDarkMode ? 'text-white' : 'text-slate-800'}`}>Description:</span> The Cloud Management Landing Page (Cloned) project is a React-based web application that replicates the design and functionality of a modern cloud management platform's landing page.
          </p>
          <p className={`text-justify ${isDarkMode ? 'text-slate-300' : 'text-slate-800'}`}>
            <span className={`font-bold ${isDarkMode ? 'text-white' : 'text-slate-800'}`}>Activities:</span>
            <ul className="list-disc list-inside">
