...
function Toolsandtechnologies() {
  ...
  <div className='flex flex-col items-center bg-slate-200 p-2 rounded-lg mb-4 min-w-[80px]'>
    <img className='mx-auto rounded-lg' src={html} alt='/' />
    <p className='text-sm text-center font-semibold'>HTML</p>
  </div>

  <div className='flex flex-col items-center bg-slate-200 p-2 rounded-lg mb-4 min-w-[100px]'>
