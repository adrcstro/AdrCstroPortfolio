...
function About({ isDarkMode }) {
  return (
    <div className={`max-w-screen-full mx-auto py-8 px-8 lg:py-16 lg:px-6 ${isDarkMode ? 'bg-gray-900 text-white'  : 'bg-white text-black'}`}>
      <div className="max-w-screen-xl text-center mb-10">
