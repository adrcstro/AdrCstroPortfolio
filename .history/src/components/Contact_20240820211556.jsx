...
function Contact() {
  return (
    ...
    <h4 className="flex items-center text-lg text-slate-400 font-bold">
  castroandew10@gmail.com
  <FaArrowUpRightFromSquare className='w-4 h-4 ml-2 text-slate-400' />
</h4>
  ...
  <div className="flex items-center  p-4 rounded-lg min-w-[70px]">
    ...
    <h4 className="text-lg text-slate-400 font-bold"><a href="https://www.facebook.com/profile.php?id=100009241129573" target="_blank" rel="noreferrer">Andre Thomas Castro</a>
</h4>
  ...
  <div className="flex items-center  p-4 rounded-lg min-w-[70px]">
    ...
    <h4 className="text-lg text-slate-400 font-bold"><a href='https://www.instagram.com/_adrcstro/ ' target="_blank" rel="noreferrer">_adrcstro</a></h4>
  ...
  <div className="flex items-center  p-4 rounded-lg min-w-[70px]">
    ...
    <h4 className="text-lg text-slate-400 font-bold"><a href='https://x.com/LiquidoAndre ' target="_blank" rel="noreferrer">@LiquidoAndre</a></h4>
  ...
  <div className="flex items-center  p-4 rounded-lg min-w-[70px]">
    ...
    <h4 className="text-lg text-slate-400 font-bold"><a href='https://github.com/adrcstro '  target="_blank" rel="noreferrer">adrcstro</a></h4>
  ...
  <div className="flex items-center  p-4 rounded-lg min-w-[70px]">
    ...
    <h4 className="text-lg text-slate-400 font-bold"><a href='https://www.linkedin.com/in/castro-andre-thomas-liquido-916628248/' target="_blank" rel="noreferrer">Castro Andre Thomas liquido</a>
</h4>
