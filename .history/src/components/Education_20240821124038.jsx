...
function Education({ isDarkMode }) {
  return (
    ...
    <div className={`flex items-center border border-slate-200 shadow-lg p-4 rounded-lg min-w-[70px] ${isDarkMode ? 'border-gray-600 bg-gray-800' : 'border-slate-100'} shadow`}>
