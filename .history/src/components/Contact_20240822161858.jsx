...
function Contact({isDarkMode}) {
  return (
    ...
    <h4 className="flex items-center text-lg text-slate-400 font-bold">castroandew10@gmail.com <a href="https://www.facebook.com/profile.php?id=100009241129573" target="_blank" rel="noreferrer"><FaArrowUpRightFromSquare className='w-4 h-4 ml-2 text-slate-400 transition-transform transform hover:scale-105'/> </a></h4>
