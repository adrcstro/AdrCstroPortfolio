...
<div className='mt-3'>
  <h3 className='font-semibold text-md bg-slate-200 inline-flex items-center px-4 py-1 rounded-full'>
    ...
    I'm Andre Castro
        ...
        <p className='text-sm'><span className='font-semibold bg-slate-200 mr-2 rounded-lg py-2 px-1'>+2.5</span>Years of<br>Experience</br></p>
        <p className='text-sm'><span className='font-semibold bg-slate-200 mr-2 rounded-lg py-2 px-1'>+2.5</span>Years of Experience</p>
        <p className='text-sm'><span className='font-semibold bg-slate-200 mr-2 rounded-lg py-2 px-1'>+2.5</span>Years of Experience</p>
        </div>
