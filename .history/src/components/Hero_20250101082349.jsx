          ...
          variants={fadeIn("left",0.2)}
           ...
           viewport={{once: false, amount:0.7}}
             className="flex items-center space-x-2 shrink-0 mt-2">
              <p className={`font-montserrat rounded-lg py-2 px-2 ${isDarkMode ? 'bg-gray-700' : 'bg-slate-200'}`}>+2.5</p>
              <p className="text-sm font-montserrat text-start">Years of<br/>Experience</p>
            </motion.div>
