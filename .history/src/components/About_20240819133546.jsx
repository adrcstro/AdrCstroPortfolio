...
function About() {
  return (
    <div className="max-w-screen-xl mx-auto py-8 px-6 lg:py-16 lg:px-8">
    <div className="text-center mb-10">
        <h2 className="text-3xl md:text-4xl tracking-tight font-bold text-primary-800">About Me!</h2>
    </div>

    <div className="flex flex-col md:flex-row">
        {/* Image section */}
        <div className="md:mr-8 mb-6 md:mb-0 flex justify-center">
            <img className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-[350px] rounded-full" src={profile} alt="can_help_banner" />
        </div>
        ...
        <div className="flex-1 flex flex-col sm:flex-row flex-wrap -mb-4 -mx-2">
            <div className="w-full sm:w-1/2 mb-4 px-2">
                <div className="h-full py-4 px-6 border border-[#570df8] border-t-0 border-l-0 rounded-br-xl">
                    <h3 className="flex text-xl md:text-2xl font-bold mb-6">Personal Identification<FcManager className="ml-2 w-6 h-7" /></h3>
            ...
            <div className="w-full sm:w-1/2 mb-4 px-2">
                <div className="h-full py-4 px-6 border border-[#570df8] border-t-0 border-l-0 rounded-br-xl">
                    <h3 className="flex text-xl md:text-2xl font-bold mb-6">Interest & Hobbies<FcIdea className="ml-2 w-6 h-7"/></h3>
                    <p className="text-sm md:text-base text-slate-500">
            ...
            <div className="w-full sm:w-1/2 mb-4 px-2">
                <div className="h-full py-4 px-6 border border-[#570df8] border-t-0 border-l-0 rounded-br-xl">
                    <h3 className="flex text-xl md:text-2xl font-bold mb-6">Goals and Aspirations<FcComboChart className="ml-2 w-6 h-7"/></h3>
                    <p className="text-sm md:text-base text-slate-500">
            ...
            <div className="w-full sm:w-1/2 mb-4 px-2">
                <div className="h-full py-4 px-6 border border-[#570df8] border-t-0 border-l-0 rounded-br-xl">
                    <h3 className="flex text-xl md:text-2xl font-bold mb-6">Skills and Abilities<FcServices className="ml-2 w-6 h-7" /></h3>
                    <p className="text-sm md:text-base text-slate-500">
