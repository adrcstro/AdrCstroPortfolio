...
<footer
      ...
      <div className="flex justify-center items-center gap-8 mx-6 py-10 text-center md:text-center">
        <div className="grid-1 grid gap-2 md:grid-cols-4 lg:grid-cols-6">
          {/* <!-- TW Elements section --> */}
          <div >
            <h6
