...
<h3 className='font-bold text-lg'>Hi Im Andre Thomas Castro</h3>
        ...
        <button className="btn btn-primary mr-2 shadow-lg rounded-full py-4">Resume</button>
        <button className="btn btn-transparent shadow-lg border border-gray-900 rounded-full ">Contact</button>
        </div>
