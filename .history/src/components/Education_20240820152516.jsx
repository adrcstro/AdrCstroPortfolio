...
function Education() {
  return (
    ...
    <div className='flex flex-col items-first bg-slate-200 p-2 rounded-lg mb-4 min-w-[70px]'>
    <img className='mx-auto rounded-lg' src={Educ1} alt='React Js' />
    <p className='text-sm text-center font-semibold'>Eulogio "Amang" Rodriguez Institute of Science and Technology</p>
  </div>
