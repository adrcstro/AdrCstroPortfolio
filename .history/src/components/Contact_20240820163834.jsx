...
function Contact() {
  ...
  <div className="flex items-center  p-4 rounded-lg min-w-[70px]">
    ...
    <h4 className="text-lg text-slate-400 font-bold"><a href="https://www.facebook.com/profile.php?id=100009241129573" target="_blank">Andre Thomas Castro</a>
</h4>
  ...
  <div className="flex items-center  p-4 rounded-lg min-w-[70px]">
    ...
    <h4 className="text-lg text-slate-400 font-bold"><a href='https://www.instagram.com/_adrcstro/ ' target="_blank">_adrcstro</a></h4>
  ...
  <div className="flex items-center  p-4 rounded-lg min-w-[70px]">
    ...
    <h4 className="text-lg text-slate-400 font-bold"><a href='https://x.com/LiquidoAndre ' target="_blank">@LiquidoAndre</a></h4>
  ...
  <div className="flex items-center  p-4 rounded-lg min-w-[70px]">
    ...
    <h4 className="text-lg text-slate-400 font-bold"><a href='https://github.com/adrcstro ' target="_blank">adrcstro</a></h4>
  ...
  <div className="flex items-center  p-4 rounded-lg min-w-[70px]">
    ...
    <h4 className="text-lg text-slate-400 font-bold"><a href='https://www.linkedin.com/in/castro-andre-thomas-liquido-916628248/' target="_blank">Castro Andre Thomas liquido</a>
</h4>
  ...
  <div className="flex items-center  p-4 rounded-lg min-w-[70px]">
    ...
    <h4 className="text-lg text-slate-400 font-bold">09284864322</h4>
