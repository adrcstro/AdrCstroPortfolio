...
function Projects() {
  ...
  <div className="card bg-blue-400 w-full shadow-xl">
    ...
    <div className="card-body items-center text-center">
      <h2 className="text-md">ResiQuest: An Automated Document Request Management System is a software solution designed to streamline and automate the process of requesting, managing, and tracking documents in residential or organizational settings.</h2>
