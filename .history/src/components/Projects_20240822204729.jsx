...
function Projects({ isDarkMode }) {
  ...
  <div className="modal-box w-full p-2 max-w-6xl h-auto md:h-[600px]">
    <form method="dialog">
      {/* Close button */}
    ...
    <div className="flex items-center  flex-col h-full p-4">
      {/* Carousel Section */}
      <div className="carousel w-10/12 shadow-lg  h-full lg:h-full md:h-full">
      ...
      <div className="w-full p-4 md:mt-4">
        ...
        <p className="mt-2 text-slate-600 text-justify"> ResiQuest: An Automated Document Request Management System is a software solution designed to streamline and 
