...
<h3 className='font-bold text-lg'>Hi Im Andre Thomas Castro</h3>
        ...
        <button className="btn btn-primary mr-2 shadow-lg">Get Started</button>
        <button className="btn btn-transparent shadow-lg border border-gray-200">Get Started</button>
        </div>
