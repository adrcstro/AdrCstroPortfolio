...
function Projects({ isDarkMode }) {
  ...
  <h2 className={`font-bold text-md px-4  ${isDarkMode ? 'text-white' : 'text-slate-800'}`}>ResiQuest:(Automated Document Request Management System Web-Application)</h2>
    ...
    <div className='flex justify-end p-4 gap-2 mt-auto'>
      <div className='bg-slate-600 rounded-lg p-2 transition-transform transform hover:scale-105'><a href='https://github.com/adrcstro/ResiQuest-BRGY409' target="_blank"><FaGithub   className='w-4 h-4 text-white '/></a></div>
