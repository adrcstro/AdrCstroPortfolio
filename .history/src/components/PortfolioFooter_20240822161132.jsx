...
<div className={`${isDarkMode ? 'bg-gray-900' : 'bg-white'} w-full`}>
  ...
  <div className={`py-6 text-center md:text-left ${isDarkMode ? 'bg-gray-800' : 'text-primary-800'}`}>
    <div className="flex flex-col gap-4 items-center md:flex-row md:gap-16 md:justify-center">
      <li href="#link1" className="text-slate-400 font-bold hover:underline">Home</li>
      <li href="#link2" className="text-slate-400 font-bold hover:underline">About</li>
      <li href="#link3" className="text-slate-400 font-bold hover:underline">Tools & Technologies</li>
      <li href="#link4" className="text-slate-400 font-bold hover:underline">Experience</li>
      <li href="#link5" className="text-slate-400 font-bold hover:underline">Project</li>
      <li href="#link6" className="text-slate-400 font-bold hover:underline">Contact</li>
    </div>
  </div>
