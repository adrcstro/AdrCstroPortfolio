...
function Projects({ isDarkMode }) {
  ...
  <div className={`card bg-blue-200 w-full shadow-xl flex flex-col ${isDarkMode ? 'bg-slate-800 text-white' : 'text-primary-800'}`}>
    ...
    <div className="py-2 px-4 flex-grow items-center text-first">
      ...
      <p className='px-4 text-sm text-white'>Brgy-409 Document Request Management System (DRMS)</p>
    </div>
