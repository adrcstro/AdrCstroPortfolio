...
<div className={`${isDarkMode ? 'bg-gray-900' : 'bg-white'} w-full`}>
  ...
  <div className={`py-6 text-center md:text-left ${isDarkMode ? 'bg-gray-800' : 'bg-gray text-primary-800'}`}>
  ...
  <li className="text-slate-400 transition-transform transform hover:scale-105 font-bold"><Link to="Technology" spy={true} smooth={true} offset={-120}  duration={500}>Tools & Technologies</Link></li>
  <li className="text-slate-400 transition-transform transform hover:scale-105 font-bold"> <Link to="Experience" spy={true} smooth={true} offset={-100}  duration={500}>Experience</Link></li>
  <li className="text-slate-400 transition-transform transform hover:scale-105 font-bold"><Link to="Projects" spy={true} smooth={true} offset={-90}  duration={500}>Projects</Link></li>
  <li className="text-slate-400 transition-transform transform hover:scale-105 font-bold"><Link to="Contact" spy={true} smooth={true} offset={-70}  duration={500}>Contact</Link></li>
</div>
