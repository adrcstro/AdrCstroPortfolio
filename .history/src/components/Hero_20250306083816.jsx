      ...
      <motion.div
       ...
       className="hero-content text-center">
        <div className="max-w-3xl">
          <div className='mt-3'>
            <h3 className={` font-montserrat font-semibold text-md inline-flex items-center px-4 py-1 rounded-full ${isDarkMode ? 'bg-gray-700' : 'bg-slate-200'} font-montserrat `}>
              Hi 
              <span className='ml-2 '>
