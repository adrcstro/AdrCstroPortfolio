...
function Contact() {
  return (
    ...
    <div className="flex items-center  shadow-lg p-4 rounded-lg min-w-[70px]">
    <img className="rounded-lg w-16 h-16 mr-4" src={contact1} alt="React Js" />
    <div className='flex-grow'> 
    <p className='text-md font-semibold text-slate-400'>Email me</p>
    <h4 className="text-sm font-bold">Bachelor of Science in Computer Science (BSCS)</h4>
